...
`pod_cidr` | "The cidr in which all pods in the cluster get the pod IP | string | `172.16.0.0/16`
...
`min_tls_version` | minimum TLS version for the storage account | string | `TLS1_2`
